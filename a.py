...
clientSocket.send("AUTH PLAIN cHl0aG9udGVzdGluZzIwMTVAZ21haWwuY29tOmFiY2RlZjEyMzQ1Njc4OQ==")
...
clientSocket.send("MAIL From: pythontesting2015@gmail.com")
recv2 = clientSocket.recv(1024)
print(recv2)
if recv2[:3] != '250':
	print ('250 reply not received from server.')
...
clientSocket.send("RCPT TO: pythontesting2016@gmail.com")
recv2 = clientSocket.recv(1024)
print (recv2)
if recv2[:3] != '250':
	print ('250 reply not received from server.')
